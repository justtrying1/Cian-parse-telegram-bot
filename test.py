...
addon = [{'сколько людей живёт в настоящий момент в квартире': 1, 'кто живёт в настоящий момент': {'девушка': ['женщина', 'не указано']}, 'характер ограничения': 'строго', 'можно ли заселиться с животными': 'да', 'изолированная ли комната': 'не указано', 'сколько комнат в квартире': 2, 'ищут ли одного человека': 'не указано', 'ищут ли двух человек': 'не указано', 'ищут ли одну женщину/девушку': 'не указано', 'ищут ли одного мужчину/парня': 'нет', 'ищут ли пару из мужчины и женщины': 'не указано', 'ищут ли пару женщин/девушек': 'да', 'ищут ли пару мужчин/парней': 'не указано'}]
#import pdb; pdb.set_trace()
