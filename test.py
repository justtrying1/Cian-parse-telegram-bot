...
addon =[{'сколько людей живёт в настоящий момент в квартире?': 2, 'кто живёт в настоящий момент': {'взрослый ребёнок': ['женщина', 0], 'арендодатель': ['мужчина', 0]}, 'характер ограничения': 'строго', 'можно ли заселиться с животными': 'не указано', 'изолированная ли комната': 'да', 'сколько комнат в квартире': 2, 'ищут ли одного человека': 'да', 'ищут ли двух человек': 'нет', 'ищут ли одну женщину/девушку': 'да', 'ищут ли одного мужчину/парня': 'нет', 'ищут ли пару из мужчины и женщины': 'нет', 'ищут ли пару женщин/девушек': 'нет', 'ищут ли пару мужчин/парней': 'нет'}]
