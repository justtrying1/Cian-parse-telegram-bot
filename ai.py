    ...
    if type == 1:
        ...
        if telegram:
            stroka = """
                ...
                Классифицируй объявление (обычно эта информация находится в первых двух строчках): сдача комнаты, сдача однокомнатной квартиры, сдача двухкомнатной квартиры, сдача студии, сдача трехкомнатной квартиры, поиск комнаты, поиск двухкомнатной квартиры, поиск однокомнатной квартиры, поиск трехкомнатной квартиры, поиск студии.
